...
async function getAccessToken(tokenUrl, basicToken) {
  ...
  const response = await axios_default.post(tokenUrl, body.toString(), {
    headers: {
...
async function generatePaymentLink(accessToken, paymentUrl, input) {
  ...
  const response = await axios_default.post(paymentUrl, body, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
      "Content-Type": "application/json"
    }
  });
  if (!((_a = response.data) == null ? void 0 : _a.payment_url) || !((_b = response.data) == null ? void 0 : _b.notif_token)) {
